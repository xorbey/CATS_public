import libs.Models.Trend.QuadraticRegressionDurbin as QuadRegDurbin
...
mk = QuadRegDurbin.QuadRegDurbin(timeseries, [], [])
...
result.append({"model": "QuadRegDurbin", "dataset": "ParamGood", "roc_table": roc_table,
